...
$result = mysqli_query($conn, "SELECT * FROM tbl_siswa WHERE nis=".$_SESSION['nis']."");
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td><a href=\"data_diri_siswa.php?id=$res[id]\"><button type='button' class='btn btn-primary' data-toggle='tooltip' data-placement='bottom' title='Lihat Biodata Siswa'>Lihat Biodata Siswa</button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
