...
if(isset($_POST['submit'])){
    ...
    if(empty($kelas) || empty($thn_ajar)){
        ...
        $result = mysqli_query($conn, "SELECT * FROM view_daftarnama WHERE kelas ='".$kelas."' AND thn_ajar = '".$thn_ajar."'");
        //print_r($result); die;  
        ...
        echo '<h5 style="text-align:center;">DAFTAR SISWA PAMARDI YUWANA BHAKTI BERDASARKAN KELAS</h5>';
        echo '</br> Daftar Siswa Kelas : '.$kelas;
