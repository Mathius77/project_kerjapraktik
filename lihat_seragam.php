        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="menu_seragam" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_seragam.php">Lihat Seragam</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Seragam</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td>".$res['id']."</td>";
                                            echo "<td><a href=\"edit_seragam.php?id=$res[id]\"><button type='button' class='btn btn-success'><i class='fa fa-pencil' aria-hidden='true' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Seragam'></i></button></a>  <a href=\"delete_seragam.php?id=$res[id]\" onClick=\"return confirm('Apakah kamu yakin ingin menghapus pakaian ini?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Seragam'><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
