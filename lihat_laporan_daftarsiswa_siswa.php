    ...
    <div id="wrapper">
        ...
        <li class="nav-item active">
                ...
                <div id="menu_laporan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_laporan_daftarsiswa_siswa.php">Transaksi Pembayaran SPP</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Lihat Transaksi Pembayaran SPP</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Input Lihat Transaksi Pembayaran SPP</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="tampil_laporan_daftarsiswa_siswa.php" target="_blank" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>Kelas</td>
                                        <td>
                                        <select  name="kelas" id="kelas" onchange="" style="width: 260px;">
                                        <option>Pilih Kelas</option>
                                            <?php
                                            include_once("koneksi.php");
                                            $result = mysqli_query($conn, "SELECT kelas FROM tbl_tipe_kelas");
                                            foreach ($result as $output) {?>
                                            <option><?php echo $output["kelas"];?></option>
                                            <?php } ?>
                                        </select>
                                        </tr>
                                        <tr> 
                                            ...
                                            <td hidden><input type="text" name="nis" style="width: 260px;" value="<?php echo $_SESSION['nis']; ?>"></td>
                                        </tr>
                                        <tr> 
                                            <td>Tanggal Akhir</td>
