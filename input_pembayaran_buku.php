        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Input Pemesanan Buku</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Input Pemesanan Buku</h6>
                        </div>
                        <div class="card-body">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(empty($nis)){
                                    ...
                                    $result = mysqli_query($conn, "INSERT INTO tbl_pesan_buku(nis, id_buku, tgl_bayar) VALUES('$nis', '$id_buku', '$tgl_bayar')");

                                    //menampilkan pesan "Data sukses ditambahkan"
                                    echo "<font color='green'>Data sukses ditambahkan.";
                                    echo "<br\><a href='lihat_pembayaran_buku.php'>Lihat Hasil</a><br>";
                                }
                            }
                            ?>
                            ...
                            <form action="input_pembayaran_buku.php" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>NIS</td>
                                            <td><input type="number" name="nis" id="nis" onfocusout="BacaPaketBuku()" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Nama Lengkap</td>
                                        ...
                                        <tr> 
                                            <td>Paket Buku</td>
                                            <td><input readonly type="text" name="paket_buku" id="paket_buku" style="width: 260px;"></td>
                                        </tr>
                                        <tr hidden> 
                                            <td>id_buku</td>
                                            <td><input readonly type="text" name="id_buku" id="id_buku" style="width: 260px;"></td>
                                        </tr>                                     
                                        <tr> 
...
<script>
    function BacaPaketBuku(){
        $.ajax(
        {
            type: "POST",
            url: 'read_single_buku.php',
            datatype: 'json',
            data: {
                nis: $("#nis").val()
            },
            success: function(data){
                ...
                $("#paket_buku").val(data["paket_buku"]);
                $("#id_buku").val(data["id_buku"]);
                $("#total_bayar").val(data["biaya"]);
