            ...
            if($user == "" || $pass == "" || $nama == "" || $email == ""){
                ...
                <div class='col-lg-8 col-xl-6'>
                    ...
                    <div class='card-body p-4 p-md-6'>
                        <h3 class='mb-4 pb-2 pb-md-0 mb-md-5 px-md-2'>Register Siswa-Siswi<hr></h3>
                        <span style=color:red;font-weight:bold>Field harus diisi!<br></span>
                        <br>
                        <a href='register_siswa.php'><- Kembali</a>
                    </div>
                    </div>
                </div>
                </div>
                ...
                mysqli_query($conn, "INSERT INTO tbl_login_siswa(username, password, namalengkap, email) VALUES('$user', md5('$pass'), '$nama', '$email')")
                ...
                <div class='col-lg-8 col-xl-6'>
                    <div class='card rounded-3'>
                    <div class='card-body p-4 p-md-6'>
                        <h3 class='mb-4 pb-2 pb-md-0 mb-md-5 px-md-2'>Register Siswa<hr></h3>
            ...
            <div class="container py-5 h-100">
                ...
                <div class="col-lg-8 col-xl-6">
                    ...
                    <div class="card-body p-4 p-md-6">
                        ...
                        <div class="text-left">
                            <a class="small" href="login_siswa.php">Kembali</a>
                        </div>
                        </form>
                    </div>
                    </div>
