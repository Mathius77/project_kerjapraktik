        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Lihat Rekap Uang Sekolah</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Input Lihat Rekap Uang Sekolah</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="tampil_rekap_uang_sekolah.php" target="_blank" method="post" name="form1">
