...
$result = mysqli_query($conn, "SELECT id, nis, nama, kelas, total_bayar, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja, bln_bayar, status FROM tbl_lihat_pembayaran WHERE nis=".$_SESSION['nis']."");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index_kasir.php">
        ...
        <li class="nav-item active">
                ...
                <div id="menu_pembayaran_spp" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="index_siswa.php">Pembayaran SPP</a>
        ...
        <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menu_laporan"
                    aria-expanded="true" aria-controls="menu_pesan_buku">
                    <i class="far fa-sticky-note" style="font-size:18px"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="profil_siswa.php">
