...
$result = mysqli_query($conn, "SELECT * FROM tbl_lihat_buku");
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="menu_buku" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_buku.php">Lihat Buku</a>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td><a href=\"edit_buku.php?id=$res[id]\"><button type='button' class='btn btn-success' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Buku'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>  <a href=\"delete_buku.php?id=$res[id]\" onClick=\"return confirm('Apakah kamu yakin ingin menghapus buku ini?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Hapus Data Buku'><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
