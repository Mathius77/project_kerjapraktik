        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Seragam</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit Seragam</h6>
                        </div>
                        <div class="card-body">
                            ...
                            $jns_pakaian = $_POST['jns_pakaian'];
                            $ukuran = $_POST['ukuran'];
                            $harga = $_POST['harga'];
                            
                            //mengecek field yang kosong
                            if(empty($thn_ajar) || empty($tingkat) || empty($jns_pakaian) || empty($ukuran) || empty($harga)){
                                if(empty($thn_ajar)){
                                ...
                                if(empty($harga)){
                                    echo "<font color='red'>Biaya masih kosong.</font><br/>";
                                        ...
                                        //update tabel
                                        $result = mysqli_query($conn, "UPDATE tbl_lihat_seragam SET thn_ajar='$thn_ajar', tingkat='$tingkat', jns_pakaian='$jns_pakaian', ukuran='$ukuran', harga='$harga' WHERE id=$id");                     
                                        //menuju ke halaman lihat_siswa.php
                                        //pengganti header:('Location:...')
                                        echo"<script> window.location.href='lihat_seragam.php';</script>";
                                    }
                                    }
                                    ?>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM tbl_lihat_seragam WHERE id='$id'");
                                    ...
                                    <a href="lihat_seragam.php" class="btn btn-secondary btn-icon-split">
                            ...
                            <form action="edit_seragam.php" method="post" name="form1">
                                    ...
                                    <tr> 
                                        ...
                                        <tr> 
                                            <td>Tingkatan</td>
                                            <td>
                                            <select  name="tingkat" style="width: 260px;">
                                                <option value="SD" <?php echo (($tingkat == "SD") ? "Selected" : "")?>>SD</option>
                                                <option value="SMP" <?php echo (($tingkat == "SMP") ? "Selected" : "")?>>SMP</option>
                                            </select>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td>Jenis Pakaian</td>
                                            <td><input type="text" name="jns_pakaian" style="width: 260px;" value="<?php echo $jns_pakaian;?>"></td>
                                        </tr>
                                        <tr> 
                                            <td>Ukuran</td>
                                            <td>
                                            <select  name="ukuran" style="width: 260px;">
                                                <option value="">==== Ukuran SD ====</option>
                                                <option value="Tidak ada ukuran">Tidak ada ukuran</option>
                                                <option value="M" <?php echo (($ukuran == "M") ? "Selected" : "")?>>M</option>
                                                <option value="L" <?php echo (($ukuran == "L") ? "Selected" : "")?>>L</option>
                                                <option value="LL" <?php echo (($ukuran == "LL") ? "Selected" : "")?>>LL</option>
                                                <option value="L.3" <?php echo (($ukuran == "L.3") ? "Selected" : "")?>>L.3</option>
                                                <option value="L.4" <?php echo (($ukuran == "L.4") ? "Selected" : "")?>>L.4</option>
                                                <option value="L.5" <?php echo (($ukuran == "L.5") ? "Selected" : "")?>>L.5</option>
                                                <option value="D" <?php echo (($ukuran == "D") ? "Selected" : "")?>>D</option>
                                                <option value="">==== Ukuran Untuk Kaos Kaki ====</option>
                                                <option value="19" <?php echo (($ukuran == "19") ? "Selected" : "")?>>19</option>
                                                <option value="20" <?php echo (($ukuran == "20") ? "Selected" : "")?>>20</option>
                                                <option value="21" <?php echo (($ukuran == "21") ? "Selected" : "")?>>21</option>
                                                <option value="22" <?php echo (($ukuran == "22") ? "Selected" : "")?>>22</option>
                                                <option value="23" <?php echo (($ukuran == "23") ? "Selected" : "")?>>23</option>
                                                <option value="24" <?php echo (($ukuran == "24") ? "Selected" : "")?>>24</option>                                               
                                                <option value="">================================</option>
                                                <option value="">==== Ukuran SMP ====</option>
                                                <option value="Tidak ada ukuran">Tidak ada ukuran</option>
                                                <option value="M" <?php echo (($ukuran == "M") ? "Selected" : "")?>>M</option>
                                                <option value="L" <?php echo (($ukuran == "L") ? "Selected" : "")?>>L</option>
                                                <option value="XL" <?php echo (($ukuran == "XL") ? "Selected" : "")?>>XL</option>
                                                <option value="L2" <?php echo (($ukuran == "L2") ? "Selected" : "")?>>L2</option>
                                                <option value="L3" <?php echo (($ukuran == "L3") ? "Selected" : "")?>>L3</option>
                                                <option value="L4" <?php echo (($ukuran == "L4") ? "Selected" : "")?>>L4</option>
                                                <option value="L5" <?php echo (($ukuran == "L5") ? "Selected" : "")?>>L5</option>
                                                <option value="L6" <?php echo (($ukuran == "L6") ? "Selected" : "")?>>L6</option>
                                                <option value="">==== Ukuran Untuk Sepatu ====</option>
                                                <option value="36" <?php echo (($ukuran == "36") ? "Selected" : "")?>>36</option>
                                                <option value="37" <?php echo (($ukuran == "37") ? "Selected" : "")?>>37</option>
                                                <option value="38" <?php echo (($ukuran == "38") ? "Selected" : "")?>>38</option>
                                                <option value="39" <?php echo (($ukuran == "39") ? "Selected" : "")?>>39</option>
                                                <option value="40" <?php echo (($ukuran == "40") ? "Selected" : "")?>>40</option>
                                                <option value="41" <?php echo (($ukuran == "41") ? "Selected" : "")?>>41</option>
                                                <option value="42" <?php echo (($ukuran == "42") ? "Selected" : "")?>>42</option>
                                                <option value="43" <?php echo (($ukuran == "43") ? "Selected" : "")?>>43</option>
                                                <option value="44" <?php echo (($ukuran == "44") ? "Selected" : "")?>>44</option>
                                                <option value="45" <?php echo (($ukuran == "45") ? "Selected" : "")?>>45</option>
                                                <option value="46" <?php echo (($ukuran == "46") ? "Selected" : "")?>>46</option>
                                                <option value="47" <?php echo (($ukuran == "47") ? "Selected" : "")?>>47</option>
                                            </select>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td>Harga</td>
                                            <td><input type="number" name="harga" style="width: 260px;" value="<?php echo $harga;?>"></td>
                                        </tr>
