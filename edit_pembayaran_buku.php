        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Pembayaran Buku</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Edit Pembayaran Buku</h6>
                        </div>
                        <div class="card-body">
                            ...
                            if(empty($nis)){
                                if(empty($nis)){
                                    echo "<font color='red'>NIS masih kosong.</font><br/>";
                                        ...
                                        //update tabel
                                        $result = mysqli_query($conn, "UPDATE tbl_pesan_buku SET nis='$nis', tgl_bayar='$tgl_bayar' WHERE id=$id");                     
                                        //menuju ke halaman lihat_siswa.php
                                        //pengganti header:('Location:...')
                                        echo"<script> window.location.href='lihat_pembayaran_buku.php';</script>";
                                    }
                                    }
                                    ?>
                                    <?php
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM v_03 WHERE id='$id'");
                            ...
                            <form action="edit_pembayaran_buku.php" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>NIS</td>
                                            <td><input readonly type="number" name="nis" id="nis" style="width: 260px;" value="<?php echo $nis;?>"></td>
                                        </tr>
                                        <tr> 
                                            <td>Nama Lengkap</td>
                                        ...
                                        <tr> 
                                            <td>Paket Buku</td>
                                            <td><input readonly type="text" name="paket_buku" id="paket_buku" style="width: 260px;" value="<?php echo $paket_buku;?>"></td>
                                        </tr> 
                                        <tr hidden> 
                                            <td>id_buku</td>
                                            <td><input readonly type="text" name="id_buku" id="id_buku" style="width: 260px;"value="<?php echo $id_buku;?>"></td>
                                        </tr>                                     
                                        <tr> 
                                            <td>Total Pembayaran</td>
                                            <td><input readonly type="text" name="biaya" id="total_bayar" style="width: 260px;" value="<?php echo $biaya;?>"></td>
                                        </tr>
                                        <tr> 
