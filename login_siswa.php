...
<body class="bg-gradient-secondary">
    ...
    if(isset($_POST['submit'])){
        ...
        if($user == "" || $pass == ""){
                    ...
                    <div class='card o-hidden border-0 shadow-lg my-5'>
                        <div class='card-body p-0'>
                                    ...
                                    <div class='p-5'>
                                        ...
                                        <br>
                                        <a href='login_siswa.php'>Kembali</a>
                                    </div>
            ...
            $result = mysqli_query($conn, "SELECT * FROM tbl_login_siswa WHERE username='$user' AND password=md5('$pass')")
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <hr>
                                        <a href="register_siswa.php" class="btn btn-google btn-user btn-block"> Register</a>
