...
$result = mysqli_query($conn, "SELECT id, nama, nis, kelas, paket_buku, biaya, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja FROM v_03");
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="menu_pesan_buku" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_pembayaran_buku.php">Lihat Pemesanan</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Pemesanan Buku</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td>Rp ".$res['biaya']."</td>";
                                            echo "<td>".$res['tgl_bayar_saja']."</td>";
                                            echo "<td><a href=\"edit_pembayaran_buku.php?id=$res[id]\"><button type='button' class='btn btn-success' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Pemesanan Buku'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>  <a href=\"delete_pembayaran_buku.php?id=$res[id]\" onClick=\"return confirm('Apakah kamu yakin ingin menghapus pembayaran buku ini?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Hapus Data Pemesanan Buku'><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
