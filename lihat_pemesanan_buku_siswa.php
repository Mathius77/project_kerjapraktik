...
$result = mysqli_query($conn, "SELECT id, nama, nis, kelas, paket_buku, biaya, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja FROM v_03 WHERE nis=".$_SESSION['nis']."");
        ...
        <li class="nav-item active">
                ...
                <div id="menu_pembayaran_spp" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="lihat_pemesanan_buku_siswa.php">Pemesanan Buku</a>
