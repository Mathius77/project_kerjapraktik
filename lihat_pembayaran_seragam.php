...
$result = mysqli_query($conn, "SELECT id, nis, nama, thn_ajar, tingkat, jns_pakaian, ukuran, jumlah, harga, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja FROM v_04 ORDER BY nis ASC");
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="menu_pesan_seragam" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_pembayaran_seragam.php">Lihat Pemesanan</a>
                    </div>
                </div>
            </li>
