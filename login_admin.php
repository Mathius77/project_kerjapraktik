...
<body class="bg-gradient-secondary">
    ...
    if(isset($_POST['submit'])){
        ...
        if($user == "" || $pass == ""){
            ...
            $result = mysqli_query($conn, "SELECT * FROM tbl_login_admin WHERE username='$user' AND password=md5('$pass')")
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <!--<hr>
                                        <a href="register_admin.php" class="btn btn-google btn-user btn-block"> Register</a>-->
