            ...
            <li class="nav-item active">
                ...
                <div id="menu_pembayaran" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="input_pembayaran.php">Input Pembayaran SPP</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Input Pembayaran SPP</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(empty($nis) || empty($nama) || empty($kelas) || empty($biaya) || empty($uang_kegiatan) || empty($ekstrakurikuler) || empty($total_bayar) || empty($target_file)){
                                    if(empty($nis)){
                                        echo "<font color='red'>NIS masih kosong.</font><br/>";
                                    }

                                    if(empty($nama)){
                                        echo "<font color='red'>Nama Lengkap masih kosong.</font><br/>";
                                    }
                                    ...
                                    if(empty($total_bayar)){
                                        echo "<font color='red'>Total Pembayaran masih kosong.</font><br/>";
                                    }

                                    if(empty($target_file)){
                                        echo "<font color='red'>Bukti Pembayaran masih kosong.</font><br/>";
                                    }

                                } else{
                                    // jika semua field terisi, maka masukkan data ke database
                                    $sql = "INSERT INTO tbl_lihat_pembayaran(nis, nama, kelas, biaya, uang_kegiatan, ekstrakurikuler, total_bayar, tgl_bayar, bln_bayar, bukti, status) VALUES('$nis', '$nama', '$kelas', '$biaya', '$uang_kegiatan', '$ekstrakurikuler', '$total_bayar', '$tgl_bayar', '$bln_bayar', '$target_file', '$status')";
                                    //echo $sql;
                                    $result = mysqli_query($conn, $sql);
                                    if($result){
                                        //menampilkan pesan "Data sukses ditambahkan"
                                        echo "<font color='green'>Data sukses ditambahkan.";
                                        echo "<br/><a href='index_kasir.php'>Lihat Hasil</a>";
                                        if (move_uploaded_file($_FILES["bukti"]["tmp_name"], $target_file)) {
                                            echo "The file ". htmlspecialchars( basename( $_FILES["bukti"]["name"])). " has been uploaded.<br>";
                                        } else {
                                            echo "Sorry, there was an error uploading your file.<br>";
                                        }
                                    }
                                    else{
                                        echo "Data yang anda masukkan sudah diinput sebelumnya.<br>";
                                    }  
                                }
                            }
                            ?>
                            ...
                            <!-- enctype="multipart/form-data" ini diperlukan dalam form karena terdapat yang di submit bukan hanya $_POST saja, melainkan ada $_FILES juga yang digunakan untuk upload gambar -->
                            <form action="input_pembayaran.php" method="post" name="form1" enctype="multipart/form-data">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>NIS</td>
                                            <td><input type="number" name="nis" id="nis" onfocusout="BacaTotalBayar()" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Nama Lengkap</td>
                                        ...
                                        <tr> 
                                            <td>Kelas</td>
                                            <td><input readonly type="text" name="kelas" id="kelas" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Biaya SPP</td>
                                            <td><input readonly type="text" name="biaya" id="biaya" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Uang Kegiatan</td>
                                            <td><input readonly type="text" name="uang_kegiatan" id="uang_kegiatan" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Ekstrakurikuler</td>
                                            <td><input readonly type="text" name="ekstrakurikuler" id="ekstrakurikuler" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Total Pembayaran</td>
                                            <td><input readonly type="text" name="total_bayar" id="total_bayar" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Tanggal Pembayaran</td>
                                            <td><input type="date" name="tgl_bayar" style="width: 260px;" value="<?php echo date('Y-m-d'); ?>"></td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                            ...
                                            <td><input type="file" name="bukti" id="bukti" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Status</td>
                                            <td>
    ...
    function BacaTotalBayar(){
        $.ajax(
        {
            ...
            success: function(data){
                ...
                $("#uang_kegiatan").val(data["uang_kegiatan"]);
                $("#ekstrakurikuler").val(data["ekstrakurikuler"]);
                $("#total_bayar").val(data["totalbiaya"]);                
