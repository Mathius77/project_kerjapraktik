            ...
            <li class="nav-item">
                ...
                <div id="menu_pesan_seragam" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="input_pembayaran_seragam.php">Input Pemesanan</a>
                    </div>
                </div>
            </li>
        </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <a href="lihat_pembayaran_seragam.php" class="btn btn-secondary btn-icon-split">
                            ...
                            <form action="" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>NIS</td>
                                            <td><input type="text" name="nis" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>id_seragam</td>
                                            <td><input type="text" name="id_seragam" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Jumlah</td>
                                            <td><input type="number" name="jumlah" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Tanggal Pembayaran</td>
                                            <td><input type="text" name="tgl_bayar" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td></td>
                                ...
                                function tampil_data($conn){
                                    $noUrut = 1;
                                    $sql = "SELECT * FROM v_04";
                                    $query = mysqli_query($conn, $sql);
                                    
                                    echo "<fieldset>";
                                    echo "<legend><h2>Data Pemesanan Seragam</h2></legend>";
                                        ...
                                        while($data = mysqli_fetch_array($query)){
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="index.php?aksi=update&id=<?php echo $data['id']; ?>">Ubah</a> |
                                    ...
                                    function ubah($conn){
                                        ...
                                        if(isset($_GET['id'])){
                                            $id=$_GET['id'];
                                            $sql = "SELECT * FROM tbl_pesan_seragam WHERE id=$id";
                                            //echo $sql;
                                            $query = mysqli_query($conn, $sql);
                                            while($data = mysqli_fetch_array($query)){
                                ...
                                ?>
                                        ...
                                        <fieldset>
                                            ...
                                            <label>NIS <input type="text" name="nis" value="<?php echo $data['nis'] ?>"/></label> <br>
                                            <label>id_seragam <input type="text" name="id_seragam" value="<?php echo $data['id_seragam'] ?>"/></label><br>
                                            <label>Jumlah <input type="number" name="jumlah" value="<?php echo $data['jumlah'] ?>"/></label> <br>
                                            <label>Tanggal Pembayaran <input type="date" name="tgl_bayar" value="<?php echo date('Y-m-d', strtotime($data['tgl_bayar'])); ?>"/></label> <br>
                                            <br>
                                            <label>
