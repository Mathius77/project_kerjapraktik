            ...
            <li class="nav-item active">
                ...
                <div id="menu_siswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="input_siswa.php">Input Siswa</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Input Siswa</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(empty($nis) || empty($nama) || empty($thn_ajar) || empty($kelas)){
                                    if(empty($nis)){
                                    ...
                                    $result = mysqli_query($conn, "INSERT INTO tbl_siswa(nis, nama, thn_ajar, kelas) VALUES('$nis', '$nama', '$thn_ajar', '$kelas')");

                                    //menampilkan pesan "Data sukses ditambahkan"
                                    echo "<font color='green'>Data sukses ditambahkan.";
                                    echo "<br/><a href='lihat_siswa.php'>Lihat Hasil</a><br>";
                                }
                            }
                            ?>
                            ...
                            <form action="input_siswa.php" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        ...
                                        <tr> 
                                            <td>Nama Lengkap</td>
                                            <td><input type="text" name="nama" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Tahun Ajaran</td>
