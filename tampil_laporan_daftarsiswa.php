...
if(isset($_POST['submit'])){
    ...
    if(empty($tgl_awal) || empty($tgl_akhir)){
        ...
        $result = mysqli_query($conn, "SELECT * FROM view_daftarsiswa WHERE tgl_bayar >'".$tgl_awal."'");
        //print_r($result); die;  
        ...
        echo '<h5 style="text-align:center;">DAFTAR SISWA PAMARDI YUWANA BHAKTI YANG SUDAH MEMBAYAR</h5>';
