                        ...
                        <div class="card-body">
                            ...
                            if(empty($nis) || empty($nama) || empty($thn_ajar) || empty($kelas)){
                                    ...
                                    if(empty($kelas)){
                                        ...
                                        //update tabel
                                        $result = mysqli_query($conn, "UPDATE tbl_siswa SET nis='$nis', nama='$nama', thn_ajar='$thn_ajar', kelas='$kelas' WHERE id=$id");                     
                            ...
                            <form action="edit_siswa.php" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        <tr> 
                                            <td>NIS</td>
                                            <td><input type="number" name="nis" style="width: 260px;" value="<?php echo $nis;?>"></td>
                                        </tr>
                                        <tr> 
                                            <td>Nama Lengkap</td>
