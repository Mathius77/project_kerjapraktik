        ...
        <li class="nav-item active">
                ...
                <div id="menu_laporan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="lihat_laporan_pemesanan_buku.php">Laporan Pemesanan Buku</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Lihat Laporan Pemesanan Buku</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Input Lihat Laporan Pemesanan Buku</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="tampil_laporan_lihat_pemesanan_buku.php" target="_blank" method="post" name="form1">
