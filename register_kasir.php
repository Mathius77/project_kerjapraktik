    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            if($user == "" || $pass == "" || $nama == "" || $email == ""){
                ...
                mysqli_query($conn, "INSERT INTO tbl_login_kasir(username, password, namalengkap, email) VALUES('$user', md5('$pass'), '$nama', '$email')")
                ...
                <div class='col-lg-8 col-xl-6'>
                    ...
                    <div class='card-body p-4 p-md-6'>
                        ...
                        <br>
                        <a href='login_kasir.php'>Login sebagai kasir</a>
                    </div>
                    </div>
                </div>
                </div>
