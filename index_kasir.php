...
$result = mysqli_query($conn, "SELECT id, nis, nama, kelas, total_bayar, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja, bln_bayar, bukti, status FROM tbl_lihat_pembayaran");
            ...
            <li class="nav-item active">
                ...
                <div id="menu_pembayaran" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="index_kasir.php">Lihat Pembayaran SPP</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Pembayaran SPP</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td>".$res['bukti']."</td>";
                                            echo "<td>";
                                            echo ($res['status'] == 'Lunas') ? '<button type="button" class="btn btn-success" style="width:120px">Lunas</button>' : '<button type="button" class="btn btn-danger" style="width:120px">Belum Lunas</button>';
                                            echo "<td><a href=\"edit_pembayaran.php?id=$res[id]\"><button type='button' class='btn btn-success' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Pembayaran'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>  <a href=\"delete_pembayaran.php?id=$res[id]&bukti=$res[bukti]\" onClick=\"return confirm('Apakah kamu yakin ingin menghapus pembayaran ini?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Hapus Data pembayaran'><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
