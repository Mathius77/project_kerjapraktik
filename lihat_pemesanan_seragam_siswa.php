...
$result = mysqli_query($conn, "SELECT id, nis, nama, thn_ajar, tingkat, jns_pakaian, ukuran, jumlah, harga, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja FROM v_04 WHERE nis=".$_SESSION['nis']." ORDER BY nis ASC");
        ...
        <li class="nav-item active">
                ...
                <div id="menu_pembayaran_spp" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="lihat_pemesanan_seragam_siswa.php">Pemesanan Seragam</a>
                    </div>
                </div>
            </li>
        <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Pemesanan Seragam</h1>
