            ...
            <li class="nav-item active">
                ...
                <div id="menu_seragam" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="input_seragam.php">Input Seragam</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Input Seragam</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Input Seragam</h6>
                        </div>
                        <div class="card-body">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if(empty($thn_ajar) || empty($tingkat) || empty($jns_pakaian) || empty($ukuran) || empty($harga)){
                                    ...
                                    if(empty($tingkat)){
                                        echo "<font color='red'>Tingkatan masih kosong.</font><br/>";
                                    }

                                    if(empty($jns_pakaian)){
                                        echo "<font color='red'>Jenis Pakaian Lengkap masih kosong.</font><br/>";
                                    }

                                    if(empty($ukuran)){
                                        echo "<font color='red'>Ukuran Seragam masih kosong.</font><br/>";
                                    }
                                    ...
                                    $result = mysqli_query($conn, "INSERT INTO tbl_lihat_seragam(thn_ajar, tingkat, jns_pakaian, ukuran, harga) VALUES('$thn_ajar', '$tingkat', '$jns_pakaian', '$ukuran', '$harga')");

                                    //menampilkan pesan "Data sukses ditambahkan"
                                    echo "<font color='green'>Data sukses ditambahkan.";
                                    echo "<br/><a href='lihat_seragam.php'>Lihat Hasil</a><br>";
                                }
                            }
                            ?>
                            ...
                            <form action="input_seragam.php" method="post" name="form1">
                                    <table width="25%" border="0" cellpadding=10 class="column">
                                        ...
                                        <tr> 
                                            <td>Jenis Pakaian</td>
                                            <td><input type="text" name="jns_pakaian" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td>Tingkatan</td>
                                            <td>
                                        ...
                                        <tr> 
                                            <td>Harga</td>
                                            <td><input type="number" name="harga" style="width: 260px;"></td>
                                        </tr>
                                        <tr> 
                                            <td></td>
