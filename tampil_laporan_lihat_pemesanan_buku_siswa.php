...
<head>
    ...
    <title>Transaksi Pemesanan Buku</title>
...
if(isset($_POST['submit'])){
    ...
    if(empty($nis)){
        ...
        $result = mysqli_query($conn, "SELECT id, nama, nis, kelas, paket_buku, thn_ajar, biaya, DATE_FORMAT(tgl_bayar, '%d/%m/%Y') as tgl_bayar_saja FROM v_03 WHERE nis='".$_POST['nis']."'");
        //print_r($result); die;  
        ...
        echo '<h5 style="text-align:center;">TRANSAKSI PEMESANAN BUKU</h5>';
        ...
        echo "<tr>";
        echo "<td colspan='7' style='text-align:right;'><strong>Total Pembayaran:</strong></td>";
