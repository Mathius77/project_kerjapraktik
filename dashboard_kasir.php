...
$data_bayarspp = mysqli_query($conn, "SELECT COUNT(status) AS jumlah FROM tbl_lihat_pembayaran GROUP BY status");
$status_bayarspp = mysqli_query($conn, "SELECT status FROM tbl_lihat_pembayaran GROUP BY status");
//$data_blmbayarspp = mysqli_query($conn, "SELECT COUNT(status) AS Status2 FROM tbl_lihat_pembayaran WHERE status='Belum Lunas'");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah data yang sudah membayar SPP (Lunas)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $lunas_spp = mysqli_query($conn, "SELECT * FROM tbl_lihat_pembayaran WHERE status='Lunas'"); 
                                            $count1 = mysqli_num_rows($lunas_spp);
                                            echo $count1; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Jumlah data yang belum membayar SPP ( Belum Lunas)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $blm_lunas_spp = mysqli_query($conn, "SELECT * FROM tbl_lihat_pembayaran WHERE status='Belum Lunas'"); 
                                            $count2 = mysqli_num_rows($blm_lunas_spp);
                                            echo $count2; ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Jumlah Uang SPP yang sudah dibayar</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $jumlah_spp = mysqli_query($conn, "SELECT SUM(total_bayar) FROM tbl_lihat_pembayaran WHERE status='Lunas'"); 
                                            $penjumlahan_spp = mysqli_fetch_array($jumlah_spp);
                                            echo "Rp " . number_format($penjumlahan_spp['SUM(total_bayar)']). ".00" ; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Uang SPP yang Belum dibayar
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php $jumlah_spp = mysqli_query($conn, "SELECT SUM(total_bayar) FROM tbl_lihat_pembayaran WHERE status='Belum Lunas'"); 
                                            $penjumlahan_spp = mysqli_fetch_array($jumlah_spp);
                                            echo "Rp " . number_format($penjumlahan_spp['SUM(total_bayar)']). ".00" ; ?></div>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    Berikut ini adalah grafik Pembayaran SPP yang memiliki Status Lunas dan Belum Lunas.
                                </div>
                            </div>
                    </div>
                    <!-- /.container-fluid -->
...
var myChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: [<?php while ($row = mysqli_fetch_array($status_bayarspp)) { echo '"' . $row['status'] . '",';}?>],
    datasets: [{
      data:[<?php while ($row = mysqli_fetch_array($data_bayarspp)) { echo '"' . $row['jumlah'] . '",';}?>],
      backgroundColor: ['#FF0303', '#4e73df', '#36b9cc'],
      hoverBackgroundColor: ['#FF0303', '#4e73df', '#2c9faf'],
