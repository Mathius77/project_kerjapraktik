        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="menu_siswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Daftar</h6>
                        <a class="collapse-item active" href="lihat_siswa.php">Lihat Siswa</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <a href="#" class="btn btn-primary btn-icon-split" onclick='naik_kelas()'>
                                        </span>
                                        <span class="text">Naik Kelas</span>
                                    </a>
                                    <a href="#" class="btn btn-danger btn-icon-split" onclick='tinggal_kelas()'>
                                        </span>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead align="center">                                       
                                        <tr>
                                            <th><input type="checkbox" onclick="PilihSemua(this);">Pilih Semua</th>
                                            <th>No.</th>
                                            <th>NIS</th>
                                            <th>Nama Lengkap</th>
                                            <th>Tahun Ajaran</th>
                                    ...
                                    <?php
                                        while($res = mysqli_fetch_array($result)){
                                            echo "<tr>";
                                            echo "<td><input type='checkbox' value='$res[nis]-$res[thn_ajar]-$res[kelas]'></td>";
                                            echo "<td>".$noUrut++."</td>"; //nomor urut ditambah 1 secara berulang.
                                            echo "<td>".$res['nis']."</td>";
                                            echo "<td>".$res['nama']."</td>";
                                            echo "<td>".$res['thn_ajar']."</td>";
                                            echo "<td>".$res['kelas']."</td>";
                                            echo "<td><a href=\"lihat_biodata_siswa.php?id=$res[id]\"><button type='button' class='btn btn-primary' data-toggle='tooltip' data-placement='bottom' title='Lihat Biodata Siswa'><i class='fas fa-user' aria-hidden='true'></i></button></a>  <a href=\"input_pembayaran_seragam.php?nis=$res[nis]\"><button type='button' class='btn btn-secondary' data-toggle='tooltip' data-placement='bottom' title='Pemesanan Baju Seragam'><i class='fas fa-tshirt' aria-hidden='true'></i></button></a> <a href=\"edit_siswa.php?id=$res[id]\"><button type='button' class='btn btn-success' data-toggle='tooltip' data-placement='bottom' title='Ubah Data Siswa'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>  <a href=\"delete_siswa.php?id=$res[id]\" onClick=\"return confirm('Apakah kamu yakin ingin menghapus siswa ini?')\"><button type='button' class='btn btn-danger' data-toggle='tooltip' data-placement='bottom' title='Hapus Data Siswa'><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
...
<script>
    function naik_kelas(){
        ...
        for (var i = 1; i < checkboxes.length; i++) {
            naik_kelas.push(checkboxes[i].checked);
            nis.push(checkboxes[i].value);
            //thn_ajar.push(checkboxes[i].value);
